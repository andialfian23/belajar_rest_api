...
|
*/
$config['rest_valid_logins'] = ['admin' => '1234', '18.14.1.0001' => 'Radheya23'];
...
// $config['rest_key_name'] = 'X-API-KEY'; //REST-KEY DEFAULT
$config['rest_key_name'] = 'kunci_rest'; //REST KEY BUATAN 
